...
This example describes how to use `dynamic-include` in a maven build.
...
You need to declare `fr.jmini.asciidoctorj:dynamic-include` as a dependency for the `org.asciidoctor:asciidoctor-maven-plugin` plugin.
